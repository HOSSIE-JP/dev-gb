...
for(let n=0;n<1000;n++){frames(gb,1);const m=memory(gb),r=m.ram,t={scene:r[sy._ce_scene-0xc000],frame:r[p+11],overruns:r[p+12],blocks:r.readUInt16LE(p+4)};if(t.scene===15&&t.blocks){active=true;elapsed++;last=t;}else if(active)break;}
