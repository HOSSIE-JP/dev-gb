...
let mainloop=fs.readFileSync(path.join(root,'engine/caravan/mainloop.c'),'utf8');
...
mainloop=mainloop.replaceAll('ce_render();','ce_profile_phase=5; ce_render(); ce_profile_phase=0;').replaceAll('ce_trace_write();','ce_profile_phase=8; ce_trace_write(); ce_profile_phase=0;').replaceAll('        ce_audio_sync();','        ce_profile_phase=9; ce_audio_sync(); ce_profile_phase=0;');
...
fs.writeFileSync(path.join(dir,'engine/caravan/mainloop.c'),mainloop);
