...
runtime=runtime.replaceAll('ce_render();','ce_profile_phase=5; ce_render(); ce_profile_phase=0;').replaceAll('ce_trace_write();','ce_profile_phase=8; ce_trace_write(); ce_profile_phase=0;').replaceAll('        ce_audio_sync();','        ce_profile_phase=9; ce_audio_sync(); ce_profile_phase=0;');
