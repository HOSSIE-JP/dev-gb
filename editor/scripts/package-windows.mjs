...
brandExecutable(path.join(out,'Caravan-Editor.exe'),path.join(root,'editor/assets/caravan-editor.ico'),version);
...
fs.writeFileSync(path.join(app,'package.json'),JSON.stringify({name:'caravan-editor',version,main:'build/main.cjs',license:'MIT'}));
