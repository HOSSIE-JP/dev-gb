...
- Read root AGENTS.md, README and config/tools.lock.json. Windows portable entrypoints: setup.cmd (interactive optional tools), bootstrap.cmd (core only; -OptionalTools selects external tools), doctor.cmd, editor.cmd PROJECT, build.cmd PROJECT -Configuration Debug/Release, test.cmd.
