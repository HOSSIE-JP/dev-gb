...
背景方向・雑魚編隊を更新し、43件の自動テストを確認しています。初版では無改造のRelease ROMをDMG/CGBエミュレーションで全3ステージクリアしました。[検証記録](../../docs/nova-spear-validation.md)に条件・結果・未確認事項を記載しています。GitHub Actionsの成功した実行から、`nova-spear-game-boy`でプレイ用ROMを取得できます。
